...
import { X, Heart, Dog, Dumbbell, Cpu, Gamepad2, UtensilsCrossed, Sparkles, Plane, ChevronLeft, ChevronRight, LucideIcon, FolderGit2, Terminal } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black p-6 md:p-10 font-mono relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mt-10 pt-8 border-t border-green-900 relative z-20">
        ...
        <div className="mt-6 text-green-700 text-xs">
          <span className="text-green-500">{'>'}</span> connection_status: <span className="text-green-400">ACTIVE</span> | uptime: <span className="text-green-400">99.9%</span> | ping: <span className="text-green-400">12ms</span>
        </div>
      </div>
